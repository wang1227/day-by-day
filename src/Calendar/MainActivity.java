...
public class MainActivity extends Activity implements OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		arrange_text = new ListView(this);
...
//			arrange_text.setText("");
	...
	private DateWidgetDayCell.OnItemClick mOnDayCellClick = new DateWidgetDayCell.OnItemClick() {
		public void OnClick(DateWidgetDayCell item) {
			...
			int moth=cal_Now.get(Calendar.MONTH);
			int year=cal_Now.get(Calendar.YEAR);
			Toast.makeText(MainActivity.this, String.valueOf(iMonthViewCurrentMonth), 500).show();
			if (calendar_Hashtable != null
					&& calendar_Hashtable.containsKey(day)) {
//				arrange_text.setText(Calendar_Source.get(calendar_Hashtable
//						.get(day)));
			} else {
//				arrange_text.setText("暂无");
			}
	...
	public void ShowListView(int year,int month,int day){
		
//		arrange_text.setAdapter();
		
		arrange_text.setOnItemClickListener(this);
	}
	@Override
